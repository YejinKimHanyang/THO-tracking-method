...
def get_frame():
    ...
    writer = cv2.VideoWriter('./output.avi', cv2.VideoWriter_fourcc(*'DIVX'), 30, (1040, 600))
    ...
    try:
        ...
        while(True):
            ...
            pad_w = (color_image.shape[1]-800)//2
            pad_h = (color_image.shape[0]-600)//2
            color_image = color_image[pad_h:color_image.shape[0]-pad_h, pad_w:color_image.shape[1]]
            ...
            #change 'out' dimension equivalent to the dimension of the resized frame
